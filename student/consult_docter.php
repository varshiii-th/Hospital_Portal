...
<head>
    ...
    <style>
        ...
        input[type="submit"]:hover {
            background: linear-gradient(180deg,rgb(45, 72, 115) 0%,rgb(73, 134, 196) 100%);
        ...
        .center-btn {
            ...
            text-align: center;
            padding: 12px 24px;
            background: linear-gradient(135deg,rgb(223, 58, 20),rgb(240, 57, 33));
            color: white;
            border-radius: 10px;
...
.center-btn:hover {
    background: linear-gradient(135deg,rgb(233, 40, 56),rgb(224, 35, 10));
    transform: translateY(-2px);
}
    </style>
</head>
        ...
        echo "<table>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if (!empty($row['doctor_photo'])) {
                        ...
                        echo "<img src='" . $imageSrc . "' width='140' height='140' alt='Doctor Photo'>";
                    } else {
