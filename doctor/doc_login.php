...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($_POST["email"]) && !empty($_POST["password"])){
        ...
        $sql3 = "SELECT * FROM Doctor WHERE email= '$email'AND password = '$password'";
        ...
        if ($result3->num_rows == 1) {
            ...
            echo '<meta http-equiv="refresh" content="3;url=doc_dashboard.php">';
        } else if ($result->num_rows == 0) {
            echo "no account";
            echo '<meta http-equiv="refresh" content="3;url=doc_signup.php">';
        } 
        else {
        ...
        echo "⚠️ Please enter both doctor_id and Password.";
    }
}
?>
<!DOCTYPE html>
...
<style>
    ...
    <form action="doc_login.php" method="post">
        ...
        <a href='../doctor.php' class='back-link'>Back_To_Index</a>
