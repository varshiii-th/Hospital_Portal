...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO professor 
        (professor_id, password, professor_name, phone, email,  sex,age, blood_group, date_of_birth, department, photo) 
        VALUES 
        ('$prof_id', '$password', '$name', '$phone', '$email',  '$sex','$age', '$blood_group', '$date_of_birth', '$department', " . ($photo ? "'$photo'" : "NULL") . ")";
        $sql2="INSERT INTO patient (id,patient_role) VALUES ('$prof_id','professor')";

    if ($conn->query($sql) === TRUE && $conn->query($sql2)==TRUE) {
        echo "✅ Professor registered successfully!";
        echo '<meta http-equiv="refresh" content="2;url=prof_login.php">';
    } 
    $conn->commit();
}
    ...
    echo '<meta http-equiv="refresh" content="2;url=prof_signup.php">';
...
<body>
    ...
    <form action="prof_signup.php" method="post" enctype="multipart/form-data">
