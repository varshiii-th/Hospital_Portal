...
if(isset($_POST['depentrytype'])){
    ...
    if ($entry==0){
        header("Location:dependent/dependent_signup.php");
        exit();
    }
    else if($entry==1){
        header("Location:dependent/dependent_login.php");
        exit();
    }
}
?>
        ...
        <main>
            <section>
                <form action="dependent.php" method="post">
                    ...
                    <label>
                        <input type="radio" value="0" name="depentrytype" required> Signup
                    </label>
                    <label>
                        <input type="radio" value="1" name="depentrytype"> Login
                    </label>
