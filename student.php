...
?>
<?php
if(isset($_POST['studententrytype'])){
    $entry=$_POST['studententrytype'];
    if ($entry==0) {
        ...
        <main>
            <section>
                <form action="student.php" method="post">
                    ...
                    <label>
                        <input type="radio" value="0" name="studententrytype" required> Signup
                    </label>
                    <label>
                        <input type="radio" value="1" name="studententrytype"> Login
                    </label>
