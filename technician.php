...
?>
<?php
if(isset($_POST['techentrytype'])){
    $entry=$_POST['techentrytype'];
    if ($entry==0) {
        header("Location:technician/technician_signup.php");
        exit();
    }
    else if($entry==1){
        header("Location:technician/technician_login.php");
        exit();
    }
}
?>
        ...
        <main>
            <section>
                <form action="technician.php" method="post">
                    <h3><b>If you are a new Technician, please select Signup; else, Login</b></h3>
                    <label>
                        <input type="radio" value="0" name="techentrytype" required> Signup
                    </label>
                    <label>
                        <input type="radio" value="1" name="techentrytype"> Login
                    </label>
