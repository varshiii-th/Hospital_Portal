...
?>
<?php
if(isset($_POST['profentrytype'])){
    $entry=$_POST['profentrytype'];
    if ($entry==0) {
        header("Location:professor/prof_signup.php");
        exit();
    }
    else if($entry==1){
        header("Location:professor/prof_login.php");
        exit();
    }
}
?>
        ...
        <main>
            <section>
                <form action="professor.php" method="post">
                    ...
                    <label>
                        <input type="radio" value="0" name="profentrytype" required> Signup
                    </label>
                    <label>
                        <input type="radio" value="1" name="profentrytype"> Login
                    </label>
