...
try{
    ...
    $sql = "INSERT INTO professor_dependent 
        (dependent_id,professor_id, password, dependent_name, phone,   sex,age, blood_group, date_of_birth,  photo) 
        VALUES 
        ('$dep_id','$prof_id', '$password', '$name', '$phone',   '$sex','$age', '$blood_group', '$date_of_birth', " . ($photo ? "'$photo'" : "NULL") . ")";
        $sql2="INSERT INTO patient (id,patient_role) VALUES ('$dep_id','dependent')";

    if ($conn->query($sql) === TRUE && $conn->query($sql2)==TRUE) {
        echo "✅ Dependent registered successfully!";
        echo '<meta http-equiv="refresh" content="2;url=dependent_login.php">';
    } 
    $conn->commit();
        ...
        echo '<meta http-equiv="refresh" content="2;url=dependent_signup.php">';
...
<head>
    ...
    <style>
        * {
        ...
        input[name="prof_id"]::placeholder {
            color: #5a7a5e;
            font-weight: 600;
        }
...
<body>
    <h2>Professor Signup Form</h2>
    <form action="dependent_signup.php" method="post" enctype="multipart/form-data">        
        <input type="text" name="dep_id" placeholder="Dependent_id" required><br>
        <input type="text" name="prof_id" placeholder="Professor_id" required><br>
